...
import com.atz.week4retrofit.model.SpokenLanguage
import com.atz.week4retrofit.R
import com.atz.week4retrofit.model.Genre
...
class LanguageAdapter(private val dataSet: List<SpokenLanguage>) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.card_listlanguage, viewGroup, false)
